import 'package:kpssapp/SORULAR/test2.dart';
import 'package:flutter/material.dart';
import 'package:kpssapp/icon.dart';

class genelyetenek extends StatefulWidget {
  @override
  _genelyetenekState createState() => _genelyetenekState();
}

class _genelyetenekState extends State<genelyetenek> {
  ...
  void butonFonksiyonu(bool secilenButon) {
    if (test_1.testBittiMi() == true) {
      showDialog(
          ...
          new AlertDialog(
            title: new Text(
                "Tebrikler testi bitirdiniz..", style: TextStyle(fontSize: 20.0)
            ),
